...
Updated to test HTTP compression by Pierre Quentel.
"""

from http import HTTPStatus

from httpcompressionserver import BaseHTTPRequestHandler, HTTPServer, \
     HTTPCompressionRequestHandler, CGIHTTPRequestHandler
import httpcompressionserver as server
...
class SimpleHTTPServerTestCase(BaseTestCase):
    class request_handler(NoLogRequestHandler, HTTPCompressionRequestHandler):
        pass
...
class SocketlessRequestHandler(HTTPCompressionRequestHandler):
...
class MiscTestCase(unittest.TestCase):
    def test_all(self):
        ...
        for name in dir(server):
            ...
            if getattr(module_object, '__module__', None) == \
